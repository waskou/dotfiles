...
return packer.startup(function(use)
  ...
  -- use("tpope/vim-repeat") -- add, delete, change surroundings (it's awesome)
  use("inkarkat/vim-ReplaceWithRegister") -- replace with register contents using motion (gr + motion)
  use("justinmk/vim-sneak")
  use("rhysd/clever-f.vim")
  -- use("t9md/vim-surround_custom_mapping")
  ...
  use({
    ...
    requires = {
      { "nvim-telescope/telescope.nvim", "nvim-telescope/plenary.nvim" },
    },
    config = function()
